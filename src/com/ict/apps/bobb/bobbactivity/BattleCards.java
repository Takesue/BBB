...
//public class BattleCards extends View {
	...
	private void moveCard(int width, int height, View view) {
		...
		if (height <= 0) {
			BattleCardDetail.LayoutParams params = (BattleCardDetail.LayoutParams)view.getLayoutParams();
	...
	private Runnable mUpdateTimeTask = new Runnable() {
		public void run() {
			...
			BattleCardDetail.LayoutParams params = (BattleCardDetail.LayoutParams)moveView.getLayoutParams();
